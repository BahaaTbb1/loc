...
import { Container, CustomInput, FormHeading, FormSide, Line, LoginTitle, Or, SubmitButton, WelcomeBack, SignGoogle, BlueTag, Banner, QouteTitle, Qoute, BannerContainer, Pattern, Form } from './Login.styles'
        ...
        <Container>
                ...
                <S.Flex direction='column' gap='24'>
                    ...
                    <Form onSubmit={formik.handleSubmit} noValidate>
                        ...
                        <S.Flex direction='column' gap='16'>
                            <CustomInput type='email' placeholder='Email' value={formik.values.email}
            ...
            <Banner>
                <BannerContainer>
                    ...
                    <Qoute>
                        Want to try out Leagues of Code first? Take advantage of our 14-day free trial
                    </Qoute>
                </BannerContainer>
            </Banner>
        </Container>
